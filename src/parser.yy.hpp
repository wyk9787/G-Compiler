...
#line 134 "src/parser.yy.hpp" // lalr1.cc:392
  ...
  public:
    ...
    union union_type
    {
      ...
      // "tfunc"
      char dummy5[sizeof(Shared_TFunc)];
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_TFUNC (const Shared_TFunc& v, const location_type& l);
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const Shared_TFunc v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
