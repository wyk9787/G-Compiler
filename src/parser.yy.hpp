...
#line 134 "src/parser.yy.hpp" // lalr1.cc:392
  ...
  public:
    ...
    union union_type
    {
      ...
      // "tbool"
      char dummy2[sizeof(Shared_TBool)];

      // "tfloat"
      char dummy3[sizeof(Shared_TFloat)];

      // "tint"
      char dummy4[sizeof(Shared_TInt)];

      // "tstruct"
      char dummy5[sizeof(Shared_TStruct)];

      // "tunit"
      char dummy6[sizeof(Shared_TUnit)];

      // typ
      char dummy7[sizeof(Shared_Typ)];

      // formal
      char dummy8[sizeof(arg_t)];

      // formallist
      char dummy9[sizeof(arglist_t)];
      ...
      // expslist
      char dummy13[sizeof(std::vector<Shared_Exp>)];
};
  ...
  basic_symbol (typename Base::kind_type t, const Shared_TStruct v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const arg_t v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const arglist_t v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::vector<Shared_Exp> v, const location_type& l);
    ...
    static inline
    symbol_type
    make_LET_ASSIGN (const location_type& l);
    ...
    static inline
    symbol_type
    make_POND (const location_type& l);
    ...
    static inline
    symbol_type
    make_END_DECL (const location_type& l);
    ...
    static inline
    symbol_type
    make_TSTRUCT (const Shared_TStruct& v, const location_type& l);
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 634,     ///< Last index in yytable_.
    ...
    , location (other.location)
  {
      switch (other.type_get ())
    {
      ...
      case 58: // "tstruct"
        value.copy< Shared_TStruct > (other.value);
        break;
      ...
      case 61: // formal
        value.copy< arg_t > (other.value);
        break;

      case 62: // formallist
        value.copy< arglist_t > (other.value);
        break;
      ...
      case 67: // expslist
        value.copy< std::vector<Shared_Exp> > (other.value);
        break;
    ...
    , location (l)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 67: // expslist
        value.copy< std::vector<Shared_Exp> > (v);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const Shared_TStruct v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const arg_t v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const arglist_t v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::vector<Shared_Exp> v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  parser::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    switch (yytype)
    {
      ...
      case 58: // "tstruct"
        value.template destroy< Shared_TStruct > ();
        break;
      ...
      case 61: // formal
        value.template destroy< arg_t > ();
        break;

      case 62: // formallist
        value.template destroy< arglist_t > ();
        break;
      ...
      case 67: // expslist
        value.template destroy< std::vector<Shared_Exp> > ();
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 58: // "tstruct"
        value.move< Shared_TStruct > (s.value);
        break;
      ...
      case 61: // formal
        value.move< arg_t > (s.value);
        break;

      case 62: // formallist
        value.move< arglist_t > (s.value);
        break;
      ...
      case 67: // expslist
        value.move< std::vector<Shared_Exp> > (s.value);
        break;
  ...
  parser::symbol_type
  parser::make_LET_ASSIGN (const location_type& l)
  {
    return symbol_type (token::TOK_LET_ASSIGN, l);
  }
  ...
  parser::symbol_type
  parser::make_DEREF (const location_type& l)
  {
  ...
  {
    return symbol_type (token::TOK_SEQ, l);
  }
  ...
  parser::symbol_type
  parser::make_POND (const location_type& l)
  {
    return symbol_type (token::TOK_POND, l);
  }
  ...
  parser::symbol_type
  parser::make_END_DECL (const location_type& l)
  {
    return symbol_type (token::TOK_END_DECL, l);
  }
  ...
  parser::symbol_type
  parser::make_TSTRUCT (const Shared_TStruct& v, const location_type& l)
  {
    return symbol_type (token::TOK_TSTRUCT, v, l);
  }



} // yy
#line 1875 "src/parser.yy.hpp" // lalr1.cc:392
